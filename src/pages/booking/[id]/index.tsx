            ...
            <div className="h-screen mt-1 mb-4 w-[65vw] flex flex-col gap-6 ">
                <div className=''>
                    <div className="flex justify-center items-center mb-8  py-4">
                        <div className='w-[40%] flex justify-center'><img className="h-[200px] w-[200px] rounded-[50%]" src={avatar} alt={name} /></div>
                        <div className=' ml-4 w-[60%] mr-[36px]'>
                            <p className="text-[20px] font-bold">Hi, i am <span className='font-bold text-[24px] text-[#e13740]'>{name}</span></p>
                            <p className=''>Chào mừng bạn đến với trang đặt lịch của tôi, hãy chọn thời gian phù hợp để tôi có thể chữa trị cho bạn nhé !</p>
                            <div className='flex items-center'>
                                <div className='bg-[#e13740] font-bold w-[40%] text-center p-2 mt-2 text-white rounded-[24px] uppercase px-1'><p>{specialist}</p></div>
                                <button onClick={showModal} className='border border-[#004aad] text-black hover:text-white duration-150 hover:bg-[#004aad] font-bold px-4 ml-6 text-center p-2 mt-2  rounded-[24px]'>ĐẶT LỊCH</button>
                            </div>
                        </div>
                    </div>
                    <div className='flex justify-center font-bold text-[24px] mb-8'><h3>DỊCH VỤ</h3></div>
                    <div className='flex justify-center px-[64px] '>
                        <div>
                            <div className='flex'>
                                <div className='text-[50px] text-[#b1d4ef]'><AiFillClockCircle/></div>
                                <div className='ml-4'>
                                    <p className='font-bold text-[18px]'>Dịch vụ 24/7</p>
                                    <p className='opacity-60 '>Cung cấp thời gian hợp lí giữa khách hàng và bác sĩ để mang lại trải nghiệm tuyệt vời nhất với dịch vụ của chúng tôi...</p>
                                </div>
                            </div>
                            <div className='flex items-center my-8'>
                                <div className='text-[50px] text-[#b1d4ef]'><GiHealthNormal/></div>
                                <div className='ml-4'>
                                    <p className='font-bold text-[18px]'>Chuyên môn tốt</p>
                                    <p className='opacity-60 '>Những bác sĩ mà chúng tôi cung cấp đến từ các bệnh viện lớn trên toàn quốc, sở hữu chuyên môn và kĩ năng tốt trong lĩnh vực họ làm việc...</p>
                                </div>
                            </div>
                            <div className='flex items-center my-8'>
                                <div className='text-[50px] text-[#b1d4ef]'><MdLocalPharmacy/></div>
                                <div className='ml-4'>
                                    <p className='font-bold text-[18px]'>Nhà thuốc online</p>
                                    <p className='opacity-60 '>Khách hàng có thể đặt mua các loại thuốc từ đơn mà bác sĩ đã kê, ngoài ra có thể mua thêm nhiều loại thuốc bổ khác...</p>
                                </div>
                            </div>
                            <div className='flex items-center'>
                                <div className='text-[50px] text-[#b1d4ef]'><AiFillSchedule/></div>
                                <div className='ml-4'>
                                    <p className='font-bold text-[18px]'>Hệ thống đặt lịch khám online</p>
                                    <p className='opacity-60 '>Khách hàng có thể trực tiếp trò chuyện với bác sĩ mà mình đã đặt một cách riêng tư và có thể lựa chọn bác sĩ của riêng mình...</p>
                                </div>
                            </div>
                        </div>
                        <div className='w-[50%] ml-4'>
                            <img className='rounded-lg h-[400px] object-cover' src = {avatar}/>
                        </div>
                    </div>
                </div>
            </div>

            <Modal title="ĐẶT LỊCH HẸN" okType='default' open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
...
function TimeButton({ start, end, onClick }: ITimeButtonProps) {
    return (
        <button className="  w-[40%] hover:bg-[#2a9d8f] p-2 rounded-[24px] text-black hover:text-white  duration-150 border border-[#afdad5]" onClick={onClick}>
            {`${start} - ${end}`}
        </button>
    );
}
