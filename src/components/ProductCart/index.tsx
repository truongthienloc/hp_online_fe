    ...
    return (
        <div className="flex items-center mt-4 cursor-pointer ">
            ...
            <div className="text-center">
                ...
                <div className="mt-2">
                    <button onClick={handleMinusClick} className="border border-solid border-[#efefef] px-[8px] ">-</button>
                    <span className=" bg-[#f5f5f7] px-[4px]">{productQuantity}</span>
                    <button onClick={handlePlusClick} className="border border-solid border-[#efefef] px-[8px] ">+</button>
                </div>
            </div>
        </div>
    )
